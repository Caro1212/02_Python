...
TODO: Wie erstelle ich mit einer Liste an Inputs die classin.txt Datei?
'''
...
path = 'C:/Users/Caroline Kries/sciebo/Forschungsprojekt Medikamenteninteraktion/04_Quellcode/02_Python/'
os.chdir(path)
...
def run_guide(input_file, r_file, train_data, test_data, latex_file_name):
    ...
    r_path = 'C:/Users/Caroline Kries/sciebo/Forschungsprojekt Medikamenteninteraktion/04_Quellcode/02_Python/' + r_file
    command = 'Rscript'
    cmd = [command, r_path]
